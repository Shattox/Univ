...
class_providing_the_interface="fr.uge.poo.paint.ex8.CoolGraphicAdapter"
included_classes=("fr.uge.poo.simplegraphics.CoolGraphics" "$interface_provided" "$class_providing_the_interface")
