...
/**
 * Exemple destin� � illustrer l'utlisation de la lib g3x
 * - les principaux types utiles
 * - les principales fonctionalit�s
...
static void draw(void)
{
  ...
  glBlendFunc(GL_SRC_ALPHA,GL_ONE_MINUS_SRC_ALPHA); /* cf. manuel OpenGl */
    ...
    /* alternative � la m�thode OpenGL, peu intuitive [cf. ./demo_scene.c] */
  ...
  if (FLAG_TEAPOT)  /* affichage li� � un bouton 'switch' - cf plus bas : fct. void ctrl(void) */
  {
...
static void quit(void)
{
  ...
  /* et rien de sp�cial � faire en sortie de programme           */
  fprintf(stdout,"bye !\n");
}
...
/*! action : la m�me chose dans l'autre sens       !*/
static void action_G(void)
{
  rouge.r+=0.01;  rouge.g-=0.01;
  vert.g +=0.01;  vert.b -=0.01;
...
{
  /* initialisation de la fen�tre graphique et param�trage Gl <g3x_window.h> */
  g3x_InitWindow(*argv,768,512);

  /* d�finition des fonctions d'ex�cution <g3x_window.h> */
  g3x_SetInitFunction(init); /* la fonction d'initialisation */
  g3x_SetCtrlFunction(ctrl); /* la fonction de contr�le      */
  ...
  /* boucle d'ex�cution principale <g3x_window.h> */
